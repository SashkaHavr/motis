#include "motis/mcraptor/mcraptor.h"
...
#include "motis/mcraptor/get_raptor_timetable.h"
#include "motis/mcraptor/raptor_query.h"
#include "motis/mcraptor/raptor_search.h"
...
mcraptor::mcraptor() : module("RAPTOR Options", "raptor") {
#if defined(MOTIS_CUDA)
